...
export const housingListingsTable = pgTable("housing_listings", {
  ...
  type: text("type").$type<"permanent_room" | "sublet" | "forming_group">().notNull(),
  ...
  status: text("status")
    ...
    .notNull()
    .default("active"),
  requireRoommateReview: boolean("require_roommate_review").notNull().default(true),
  subletStart: text("sublet_start"),
  subletEnd: text("sublet_end"),
